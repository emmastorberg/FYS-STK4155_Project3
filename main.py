...
def main():
    ...
    utils.make_animation(utils.matrix_to_dict(u, save_step=30), x, dt, title="Heat Diffusion in 1D Rod Determined Analytically", filename="diffusion_analytical.gif")
